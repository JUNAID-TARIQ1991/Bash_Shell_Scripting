...
while [ $pdfindex -le $n ]; do
    ...
    echo "executable = /afs/cern.ch/user/j/jtariq/POWHEG-BOX-V2/Z/$inputname1/$pdfindex/testrun-lhc-8TeV/$pdfindex.sh" >>$pdfindex.sub
    echo "should_transfer_files = YES" >>$pdfindex.sub
    echo "transfer_input_files =$wp/$pdfindex/testrun-wm-lhc-8TeV/powheg.input,$wp/$pdfindex/testrun-wm-lhc-8TeV/pwhg_main " >>$pdfindex.sub
    ...
    echo "+jobflavour="longlunch"" >>$pdfindex.sub
