...
echo "This set has 50 member PDFs. mem=0 --> central value; mem=1-50 --> eigenvector sets"
echo 
echo "For central value set pdf index to 11200 and for eigenvectors set 11201-11250.  "
echo
...
echo "This set has 50 member PDFs. mem=0 --> central value; mem=1-50 --> eigenvector sets"
echo 
echo "For central value set pdf index to 11200 and for eigenvectors set 11200-11250.  "
echo
echo "!!!!!!!For w+ set idvecbos 24  and for W- set idvecbos -24 "
echo
echo "***********************set the pdf index************************"
