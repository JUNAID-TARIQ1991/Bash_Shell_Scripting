...
echo
echo 
echo "******using HERAPDF20-NNLO PDF SET*******"
echo 
echo 
...
echo "This set has 28 member PDFs. mem=0 --> central value; mem=1-27 --> eigenvector sets"
echo 
echo "For central value set pdf index to 61200 and for eigenvectors set 61201-61228.  "
echo
...
echo "This set has 28 member PDFs. mem=0 --> central value; mem=1-28 --> eigenvector sets"
echo 
echo "For central value set pdf index to 61200 and for eigenvectors set 61201-61228.  "
echo
echo "!!!!!!!For w+ set idvecbos 24  and for W- set idvecbos -24 "
